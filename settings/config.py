...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='5a2825cfa43d92', description="Username for SMTP server")
    smtp_password: str = Field(default='631f15adccb135', description="Password for SMTP server")
